        ...
        <div class="content">
            ...
            <div class="sidebar">
                ...
                <div class="name-sb">
                    ...
                    <li><a href="quantri.php?page_layout=danhsachSP"><i class="fa-solid fa-shirt" style="font-size:20px"></i> Sản Phẩm</a></li>
                    <li><a href="quantri.php?page_layout=danhsachKH"><i class="fa-solid fa-person" style="font-size:20px"></i> Khách Hàng</a></li>
                    <li><a href="quantri.php?page_layout=danhsachDH"><i class="fa-solid fa-book" style="font-size:20px"></i> Đơn Hàng</a></li>
                    <li><a href="quantri.php?page_layout=danhsachKhoHang"><i class="fa-solid fa-warehouse" style="font-size:20px"></i> Kho Hàng</a></li>
                    <li><a href="quantri.php?page_layout=danhsachSuKien"><i class="fa-solid fa-calendar-check" style="font-size:20px"></i> Sự Kiện</a></li>
                    <li><a href="quantri.php?page_layout=danhsachTheLoai"><i class="fa-solid fa-ring" style="font-size:20px"></i> Loại Đồ</a></li>
                    <li><a href="quantri.php?page_layout=danhsachLichSu"><i class="fa-solid fa-clock-rotate-left" style="font-size:20px"></i> Lịch Sử Mua</a></li>
                    <li><a href="quantri.php?page_layout=danhsachBinhLuan"><i class="fa-solid fa-comment" style="font-size:20px"></i> Bình Luận</a></li>
                    <li><a href="quantri.php?page_layout=danhsachMau"><i class="fa-solid fa-paintbrush" style="font-size:20px"></i> Màu</a></li>
                    <li><a href="xulydangxuat.php"><i class="fa-solid fa-arrow-right-to-bracket" style="font-size:20px"></i> Logout</a></li>
                </ul>
            </div>     
    </div>
<!----------------------------------------- end content ----------------------------------------->
    <footer class="main-footer dis-flex">
        <p>Copyright &copy; 2022 <a href="#">WibuGangZ .</a>All rights reserved</p>                                         
    </footer>    
</body>
</html>
