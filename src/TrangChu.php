...
<body>
    <div class="formMain" align="center">
        <div class="formMain-Image-container">
            ...
            <div class="formMain-Image">
                ...
                <div class="image-item">
                    <img class="formMain Image-Introduce" src="https://theme.hstatic.net/1000388594/1000727279/14/slideshow_1.jpg?v=623" alt="">
                </div>
                <div class="image-item">
                    <img class="formMain Image-Introduce" src="https://theme.hstatic.net/1000388594/1000727279/14/slideshow_5.jpg?v=623" alt="">
                </div>
            </div>
    ...
    <section id="Top_Product">
            ...
            <?php                    
                ...
                {?>
                    <div class="SubProduct">
                        ...
                        <div style="display:flex; width:100%; justify-content:center">
                            <p style="text-decoration:line-through; color:gray; font-weight:500; font-size: 15px; margin: auto 10px"><?php echo format_money($rowSKSale['giaSP'],0,'','.')?></p>
     ...
     <section class="Instruction__section1">
            <div class="Instruction__section1__Contain">
                ...
                <p>Với kinh nghiệm 100 năm sản xuất trang sức thủ công, chúng tôi tin rằng bạn sẽ hài lòng với sản phẩm của chúng tôi. Giá cả phải chăng, mẫu mã đẹp mắt, màu sắc đa dạng, chúng tôi cam kết sẽ làm bạn hài lòng.</p>
            </div>
    </section>
        ...
        <div class="newPage__Container">
            ...
            <div class="newPage__mainContainer">
                <div class="newPage_sub">
                        <img src="//bizweb.dktcdn.net/100/332/764/articles/deo-kinh-hang-hieu-sao-viet-nao-sanh-dieu-nhat-b016f6.jpg?v=1540197035383" alt="">
                        ...
                        <div class="newPage__Container__Content">
                            ...
                            <p>
                                ...
                                Mọi người đều biết tới những nguy hiểm của ánh nắng mặt trời đối với làn da của chúng ta. Nhưng nhiều người khôn...
                    ...
                    <div class="newPage_sub">
                        ...
                        <img class="newPage__Img__Middle" style="margin-top: 0; height:250px" src="//bizweb.dktcdn.net/100/332/764/articles/kinh-ram-can-rayban-club-master-3.jpg?v=1544064669880"  alt="">
                    </div>
                    ...
                    <div class="newPage_sub">
                        ...
                        <div class="newPage__Container__Content">              
                            ...
                            <p>
                                Nhanh chân lên nào các khách hàng thân yêu của Wibugang ơi! Chúng tôi đang tưng bừng khai trương cửa hàng...
                            </p>
                        </div>    
                    </div>
                </div>
    ...
    <script>
        ...
        ScrollReveal().reveal('.Introduce', { delay: 10, origin: 'top', interval: 100 });
        ScrollReveal().reveal('.Clothes img', { delay: 30, origin: 'top', interval: 200 });
        ScrollReveal().reveal('.BrandItem', { delay: 40, origin: 'top', interval: 50 });
        ScrollReveal().reveal('.TitleItem', { delay: 200, origin: 'left'});
        ScrollReveal().reveal('.Instruction__section1__Contain h3', { delay: 200, origin: 'top'});
        ScrollReveal().reveal('.Instruction__section1__Contain hr', { delay: 30, origin: 'left'});
        ScrollReveal().reveal('.Instruction__section1__Contain p', { delay: 200, origin: 'left'});
        ScrollReveal().reveal('.newPage_sub img', { delay: 5, origin: 'top'});
        ScrollReveal().reveal('.newPage__Img__Middle', { delay: 5, origin: 'bottom'});
        ScrollReveal().reveal('.newPage__Container__Content p', { delay: 100, origin: 'left'});
        ScrollReveal().reveal('.Nav_Review', { delay: 5, origin: 'top'});
        ScrollReveal().reveal('.custom-bottom h3', { delay: 5, origin: 'top'});
        ScrollReveal().reveal('.custom-bottom h2', { delay: 5, origin: 'right'});
        ScrollReveal().reveal('.des-1', { delay: 5, origin: 'bottom'});
        ScrollReveal().reveal('.des-2', { delay: 5, origin: 'left'});
    </script>
</body>
</html>
